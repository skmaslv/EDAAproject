...
if __name__ == "__main__":
    ...
    #===================================================================
    SERVER_URL = "http://192.168.1.101:5001/drone"
    #===================================================================
    ...
    # drone_long and drone_lat is the final location when drlivery is completed, find a way save the value, 
    # and use it for the initial coordinates of next delivery
    
    #=============================================================================
    with open('/home/trissan/InfoCom-Drone-5-Multi-drone_System-main/pi/stored_local_cords.txt', 'w') as file:
        file.write(f'{drone_long}, {drone_lat}')
